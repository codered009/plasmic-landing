...
import * as sty from "./PlasmicIconLink.module.css"; // plasmic-import: Yi8dTK5Qw5mqM/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(defaultcss.all, sty.svg__gPskp)}
              role={"img"}
            />
          ),
