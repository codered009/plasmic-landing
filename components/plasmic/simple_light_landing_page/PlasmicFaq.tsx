...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: 1JewPJM9Yh0GNt/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__bjiYj)}
      >
        <div className={classNames(defaultcss.all, sty.freeBox__znAo)}>
          <div className={classNames(defaultcss.all, sty.freeBox__xgDTv)}>
            {p.renderPlasmicSlot({
