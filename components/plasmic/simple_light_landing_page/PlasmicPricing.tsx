...
import Plan from "../../Plan"; // plasmic-import: KrGuEgPbi_O9Ga/component
...
import Faq from "../../Faq"; // plasmic-import: 1JewPJM9Yh0GNt/component
...
import * as sty from "./PlasmicPricing.module.css"; // plasmic-import: ulK5Mg_zKRcoAA/css
      ...
      <div className={defaultcss.plasmic_page_wrapper}>
        ...
        >
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.freeBox__i0Nu8)}
          >
            <Header
            ...
            <Section
              className={classNames("__wab_instance", sty.section__ldHs2)}
              subtitle={
            ...
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(defaultcss.all, sty.freeBox__wGlVk)}
            >
              <Plan
                className={classNames("__wab_instance", sty.plan___7Zz7)}
                price={
                  <div
                    className={classNames(
                      defaultcss.all,
              ...
              <Plan
                className={classNames("__wab_instance", sty.plan__n7U48)}
                description={
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(defaultcss.all, sty.freeBox__uBrW)}
                  >
                    <Bullet
                      className={classNames("__wab_instance", sty.bullet__affd)}
                    />
              ...
              <Plan
                className={classNames("__wab_instance", sty.plan__aKbef)}
                name={"Enterprise"}
                price={
                  <div
                    className={classNames(
            ...
            <Section
              className={classNames("__wab_instance", sty.section__uikae)}
              subtitle={
                <React.Fragment>
                  <div
                    className={classNames(
                  ...
                  <Faq
                    className={classNames("__wab_instance", sty.faq__h2Cfm)}
                    slot={
                  ...
                  <Faq
                    className={classNames("__wab_instance", sty.faq__x7QAw)}
                    slot={
                      "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                    }
                  >
                  ...
                  <Faq
                    className={classNames("__wab_instance", sty.faq__lZiMc)}
                    slot={
                      "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                    }
                  >
