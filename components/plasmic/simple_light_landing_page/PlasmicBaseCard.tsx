...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: LuOAK2RK5X-muh/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.freeBox__zQp8H, {
          [sty.freeBox__long__zQp8HuOsx6]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.freeBox__nff6I, {
            [sty.freeBox__long__nff6IuOsx6]: hasVariant(
              variants,
              "long",
              "long"
            )
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg__cz29J)}
                role={"img"}
              />
            ),
