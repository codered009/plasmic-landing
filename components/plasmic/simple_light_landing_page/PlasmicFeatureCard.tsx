...
import * as sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: mYOUcFCBUoI-K/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? false : true) ? (
        <div
          className={classNames(defaultcss.all, sty.freeBox___0PeSp, {
            [sty.freeBox__long___0PeSpNzB0T]: hasVariant(
              variants,
              "long",
              "long"
            )
        ...
        >
          <div
            className={classNames(defaultcss.all, sty.freeBox__aPiO, {
              [sty.freeBox__long__aPiONzB0T]: hasVariant(
                variants,
                "long",
                "long"
              )
          ...
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <svg
                  className={classNames(defaultcss.all, sty.svg__zhnJd)}
                  role={"img"}
                />
              ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__jSSdt, {
          [sty.freeBox__long__jSSdtNzB0T]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.freeBox__v3QYl, {
            [sty.freeBox__long__v3QYlNzB0T]: hasVariant(
              variants,
              "long",
              "long"
            )
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg__tedJj)}
                role={"img"}
              />
            ),
