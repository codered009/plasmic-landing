...
import Avatar from "../../Avatar"; // plasmic-import: ZL3D4lfWpgYgDo/component
...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: I4u0Q3fhCPQEZe/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: cnezcsx5GAJKKV/icon
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__fOvTy)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__zsTy)}
        >
          <div
            className={classNames(
              defaultcss.all,
